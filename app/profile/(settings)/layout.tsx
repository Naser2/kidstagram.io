  ...
  return (
    <div className="flex">
      <Tabs
        ...
        className="my-8 sm:my-0 max-[500px]:max-w-[200px] md:w-[250px] min-h-screen fixed space-y-8 left-4 top-0 md:ml-20 lg:ml-64 h-full flex flex-col lg:border-r px-0 py-12"
...
<h4 className="font-extrabold text-xl text-white ml-1 flex items-center">
      ...
      <div className={clsx(width > 740 ? "ml-[230px]" : " ml-[70px] flex-1  xl:ml-54 min-h-screen bg-white dark:bg-neutral-950")}>
        {children}
      </div>
    </div>
  );
