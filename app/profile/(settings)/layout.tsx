...
const tabs = [
  ...
  { title: "Emails from kidstagram", value: "emails-from-kidsagram" },
];
          ...
          {tabs.map((tab) => (
            <TabsTrigger
              ...
              className={cn(
                ...
                "data-[state=active]:bg-zinc-100 dark:data-[state=active]:bg-neutral-800 dark:hover:bg-neutral-900 w-full justify-start !px-3 lg:px-5"
              )}
            >
