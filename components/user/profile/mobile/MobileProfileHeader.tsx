...
import { ProfileAvatar, ProfileAvatarImage, ProfileAvatarFallback } from "./MobileAvatar"
type Props = {
  ...
  return ( 
    ...
    <div className="max-[765px]:w-full max-[765px]:!inline-flex max-[765px]:pt-6 max-[765px]::flex-row  smax-[765px]::items-start max-[765px]:gap-5 px-4">
       {/* Profile Avatar - 1/3 Screen */}
        ...
        <MobileProfileAvatar user={profile} isProfileOwner={isProfileOwner} >
          <ProfileAvatarImage  alt="Profile avatar" />
          <ProfileAvatarFallback>U</ProfileAvatarFallback>
        </MobileProfileAvatar>

          {/* <MobileUserAvatar 
            user={profile}  
               isProfileOwner={isProfileOwner}
             avatarSize="h-[9.48rem] w-[9.48rem]"
          >
            <MobileUserAvatar
              isProfileOwner={isProfileOwner}
              user={profile}
              // className="w-23 h-23 md:w-36 md:h-36 cursor-pointer"
            />
          </MobileUserAvatar> */}
        </div>
