...
type Props = {
 ...
 function ProfileHeaderMobile({profile, session, isProfileOwner, suggestAccountsVisible, toggleSuggestAccountsVisible}:
  ...
  return ( 
    ...
    <div className="max-[765px]:w-full max-[765px]:!inline-flex max-[765px]:pt-6 max-[765px]::flex-row  smax-[765px]::items-start max-[765px]:gap-5 px-4">
       {/* Profile Avatar - 1/3 Screen */}
        ...
        <ProfileAvatarLarge user={profile} viewPort="sm-md"
                         isProfileOwner={isProfileOwner} 
                         avatarSize="h-[6.2rem] w-[6.2rem]"
                         >
            <UserAvatarLarge 
               isProfileOwner={isProfileOwner}
              user={profile}
