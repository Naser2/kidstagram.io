...
function ProfileHeader({ username }: { username: string | null }) {
  return (
    <header className="mobile_header fixed md:hidden bg-white top-0 flex items-center dark:bg-neutral-950 w-full z-50 border-b [border-zinc-300 dark:border-neutral-700] px-3 py-1 sm:-ml-6">
      <Button className="setting_icon_tag_tab"
